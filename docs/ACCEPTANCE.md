...
G09 through G13 passed local lead review at code candidate `b92f828f5163b192a941c56d8a99efc65489b822` on Debian GNU/Linux 13. The cumulative source suite passed 61/61. A wheel built from `git archive b92f828` was installed with runtime dependencies into a fresh CPython 3.12.13 virtual environment; the same 61/61 tests passed outside the checkout without `PYTHONPATH`. The wheel is `/tmp/harness-relay-pr4-exact.wmryN6/artifacts/harness_relay-0.1.0a1-py3-none-any.whl`, SHA-256 `6266c3c54577623a9b5c7a1770d72dd79f2a42394ded2f88da0a22ec78b24ef8`.
