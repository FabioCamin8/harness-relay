...
G03 and G04 are not marked accepted here. Candidate evidence remains pending exact-SHA review. The PR handoff must record the candidate SHA, source and packaged test commands, environment and dependency versions, observed outcomes, and artifact locations before assigning any gate disposition. No live worker task, MCP runtime, worktree, lifecycle, doctor, CI/release, or G14 claim is made here.
