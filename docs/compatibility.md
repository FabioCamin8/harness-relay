...
Status at PR-2 candidate verification, 2026-09-08: **the package foundation and offline configuration/setup behavior have been verified on Debian GNU/Linux 13 with Python 3.13.5; no native HarnessRelay adapter or MCP protocol version has been verified**. This matrix records setup/discovery boundaries, not live worker capability.
...
| Linux, non-root user | First required platform | PR-1 package foundation and PR-2 offline setup verified on Debian GNU/Linux 13 with Python 3.13.5; later product capabilities remain unverified. |
